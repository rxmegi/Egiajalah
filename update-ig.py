...
for xc in range(1000):
    rr = random.randint
    rc = random.choice
    uaz1 = f"Mozilla/5.0 (Linux; Android {VA}; {vivo} Build/{VB}.{VB2}.{VB1}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{VC} Mobile Safari/537.36"
    uaz2 = f"Mozilla/5.0 (Linux; Android {VA}; Redmi Note {str(rr(7,12))} Build/{VB}.{VB2}.{VB1}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{VC} Mobile Safari/537.36"
    uaz3 = f"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{chrome} Safari/537.36"
